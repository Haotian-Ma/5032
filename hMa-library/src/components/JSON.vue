  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        ...
        <!-- Nested v-for to iterate through each author's famous works -->
      ...
      <!-- TODO: CODE TO RENDER LIST OF AUSTEN'S WORKS HERE -->
       <ul>
        <li v-for="famousWork in austen.famousWorks" :key="famousWork.title">
          {{ famousWork.title }}
        </li>
       </ul>
    </section>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(hours, kindOfDay) in bookstores.openingHours" :key="kindOfDay">
          {{ kindOfDay }} : {{ hours.open }} - {{ hours.close }}
        </li>
       </ul>
